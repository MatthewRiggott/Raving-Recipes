...
Also supplied is a postgresql dump file - raving_recipes.dump.  This can be used to seed your database.  This comes with keywords already extracted for all recipes.
